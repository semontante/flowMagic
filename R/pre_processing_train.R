...
#' 
#'In other words it generates the dataset that indicates what cells belong to the selected pop (1) 0 otherwise.
...
#' @export
#' @examples 
#' \donttest{pre_process_manual_binary()}


pre_process_manual_binary<-function(gh,pop){
...
#' @param gh GatingHierarchy.
#' @param binary_df Dataframe generated by the pre_process_manual_binary function.
#' @return Dataframe.
#' @export
#' @examples 
#' \donttest{subsetting_binary_df()}

# 
subsetting_binary_df<-function(gh,binary_df){
